...
class PropagatorWidget(QWidget):
        ...
        try:
            ...
            if self.world is None:
                ...
                with zipfile.ZipFile(BytesIO(response.content)) as z:
                    z.extractall('/tmp/naturalearth')
                self.world = gpd.read_file('/tmp/naturalearth/ne_110m_admin_0_countries.shp')
            
            self.world.plot(ax=self.ax, color='lightgray', edgecolor='black', linewidth=0.5)
        except:
    ...
    def _draw_trajectory(self):
        ...
        self.trajectory_line, = self.ax.plot(wrapped_lons, wrapped_lats, 'b-', linewidth=1.5, alpha=0.6, label='Trajectory')
